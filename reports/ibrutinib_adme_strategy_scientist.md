...
Mode: scientist
Audience focus: Internal DMPK, ADME, and project-science discussion.
Mode summary: Scientist mode keeps the fullest technical view, including chemistry, evidence-linking, confidence layering, and literature traceability.
...
Skill context loaded from: No external skill context loaded..
